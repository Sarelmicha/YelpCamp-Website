...
//COMMENT EDIT ROUTE
router.get("/:comment_id/edit",middleware.checkCommentOwenrship, function(req, res){
...
//COMMENTS UPDATE
router.put("/:comment_id", middleware.checkCommentOwenrship, function(req, res){
...
router.delete("/:comment_id",middleware.checkCommentOwenrship, function(req, res){
	//findByIdAndRemove
